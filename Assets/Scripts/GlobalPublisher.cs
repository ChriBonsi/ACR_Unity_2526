...
public class ROSGlobalPublisher : MonoBehaviour
{
    void Awake()
    {
        ...
        ros.RegisterPublisher<ObstacleManagerObstacleReportMsg>("obstacle_manager/report_obstacle");
        ros.RegisterPublisher<RobotManagerRobotSubscriberMsg>("robot_manager/request_robot");
